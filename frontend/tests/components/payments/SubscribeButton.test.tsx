...
describe("SaveCardForm", () => {
    ...
    it("displays error message on failed API call", async () => {
        ...
        expect(onError).toHaveBeenCalledWith("Konnte Checkout-Session nicht erstellen.")
    })
});
