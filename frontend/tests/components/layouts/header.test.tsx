...
describe("HeaderNavigation", () => {
    ...
    it("shows nav items", () => {
        ...
        const modulesAndLearningContent = screen.getByRole("link", { name: "Module & Lerninhalte" })
    ...
    expect(screen.getByRole("link", { name: "Abonnements" })).toHaveAttribute("href", "/subscriptions");
  });
  ...
  it("does not duplicate /subscriptions link if already present", () => {
    ...
    const subscriptionLinks = screen.getAllByRole("link", { name: "Abonnements" });
