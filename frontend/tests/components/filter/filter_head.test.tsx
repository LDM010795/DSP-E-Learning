...
describe('FilterHead', () => {
    test('renders title and children', () => {
        ...
        expect(screen.getByRole('button', { name: 'Kind-Action' })).toBeInTheDocument();
    });
    ...
    test('shows search input only when showSearch is true and onSearchChange provided', () => {
        ...
        rerender(<FilterHead title="T" showSearch={true} onSearchChange={onSearch} />);
    ...
    test('typing updates input and calls onSearchChange (debounce mocked immediate)', async () => {
        ...
        render(<FilterHead showSearch onSearchChange={onSearch} searchPlaceholder="Suche hier" />);
    ...
    test('syncs external searchTerm prop to input and avoids redundant onSearchChange', async () => {
       ...
       rerender(<FilterHead showSearch onSearchChange={onSearch} searchTerm="extern" />);
    ...
    test('placeholder can be customized', () => {
        render(<FilterHead showSearch onSearchChange={() => {}} searchPlaceholder="Module suchen" />);
