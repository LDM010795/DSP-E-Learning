...
describe("ClozeBlankDropSlot", () => {
    ...
    it("setzt und entfernt Hover-Klasse bei DragEnter/DragLeave", () => {
        ...
        for (const token of (styles?.bankHover ?? "").split(/\s+/).filter(Boolean)) {
    ...
    it("onDrop ignoriert Drops ohne Daten", () => {
        const onDropWord = vi.fn();
        render(
            <ClozeBlankDropSlot id="b5" exerciseId="ex1" onDropWord={onDropWord} display_mode="text" />,
        );
    ...
    it("onDrop ignoriert Drops aus fremder ExerciseId", () => {
        const onDropWord = vi.fn();
        render(
            <ClozeBlankDropSlot id="b6" exerciseId="ex1" onDropWord={onDropWord} display_mode="text" />,
        );
