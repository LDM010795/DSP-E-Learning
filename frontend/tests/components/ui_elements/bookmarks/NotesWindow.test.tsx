...
vi.mock("@components/ui_elements/overlays/DraggableResizableWindow.tsx", () => ({
...
describe("NotesWindow", () => {
    it("renders only if open=true", () => {
        const { rerender } = render(
            <NotesWindow open={false} value="test" onChange={() => {}} onClose={() => {}} />
        );
        expect(screen.queryByTestId("window")).toBeNull();

        rerender(
            <NotesWindow open={true} value="test" onChange={() => {}} onClose={() => {}} />
        );
    ...
    it("calls onChange when typing in NotesEditor", () => {
        ...
        render(<NotesWindow open value="abc" onChange={handleChange} onClose={() => {}} />);
        fireEvent.change(screen.getByTestId("editor"), { target: { value: "xyz" } });
    ...
    it("shows correct character count", () => {
        render(<NotesWindow open value="<b>abc</b>" onChange={() => {}} onClose={() => {}} />);
    ...
    it("triggers export with correct filename", () => {
        ...
        vi.spyOn(HTMLAnchorElement.prototype, "remove").mockImplementation(removeSpy);

        render(<NotesWindow open value="abc" onChange={() => {}} onClose={() => {}} />);
