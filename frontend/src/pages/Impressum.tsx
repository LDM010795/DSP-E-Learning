        ...
        <div className="mx-auto px-6 py-12">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-8 mb-12">
                ...
                <div className="flex-1 text-center lg:text-left">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                        ...
                        einschließlich Kontaktinformationen und Verantwortlichkeiten.
                    </p>
                </div>
            </div>
            ...
            <div className="space-y-8 ">
                <section className="bg-gray-50 p-6 rounded-lg shadow-md">
                    ...
                    <p className="mb-2">
                        Kontakt: <a href="mailto:info.contact@datasmartpoint.de" className="text-dsp-orange underline">info.contact@datasmartpoint.de</a><br />
                        030-16634387
                    </p>
                    <p className="mb-2">
                        Eingetragen bei: Amtsgericht Berlin (Charlottenburg), Deutschland<br />
                        Register-ID: HRB 251575
                    </p>
                    <p className="mb-2">
                        Rechtlicher Hinweis: Alle Rechte an den Inhalten dieser Website sind vorbehalten. Jede kommerzielle Nutzung bedarf der vorherigen Zustimmung des Rechteinhabers.
                        Diese Website kann Links zu Websites Dritter enthalten. Eine Haftung für die Inhalte dieser Links können wir nicht übernehmen.
                    </p>
                    <p>
                        OS-Plattform: Die Europäische Union hat eine Online-Plattform („OS-Plattform“) zur außergerichtlichen Beilegung von Verbraucherrechtsstreitigkeiten eingerichtet: <a href="https://ec.europa.eu/consumers/odr" target="_blank" className="text-dsp-orange underline">https://ec.europa.eu/consumers/odr</a>
                    </p>
                </section>
                ...
                <section className="bg-gray-50 p-6 rounded-lg shadow-md">
                    ...
                    <p className="leading-relaxed">
                        ...
                        Falls Sie auf eine Urheberrechtsverletzung aufmerksam werden, bitten wir um einen Hinweis. Wir entfernen die Inhalte dann umgehend.
                    </p>
                </section>
            </div>
        </div>
