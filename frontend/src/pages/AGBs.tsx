    ...
    return (
        <div className="max-w-7xl mx-auto px-6 py-12 space-y-12">
            ...
            <div className="mb-8">
                ...
                Transparenz & Fairness für deine Sicherheit. Hier findest du alle wichtigen Informationen zu unseren Geschäftsbedingungen, Leistungen und Rechten.
                </p>
            </div>
            ...
            <section className="bg-gray-50 p-6 rounded-lg shadow-md space-y-4">
                <div className="flex items-center mb-2">
                    <div className="w-1 h-6 bg-orange-500 mr-3 rounded"></div>
                    <h2 className="text-2xl font-semibold">Voraussetzungen zur Teilnahme</h2>
                </div>
                <p>An dem Lehrgang beim Bildungsträger kann jeder teilnehmen, sofern die Zugangsvoraussetzungen in einem formlosen Feststellungsverfahren seitens des Bildungsträgers ermittelt und bestätigt worden sind. Wird eine Förderung (z. B. nach dem SGB III) in Anspruch genommen, gilt es, die gesonderten Zugangsvoraussetzungen des jeweiligen Förderinstituts ebenfalls zu erfüllen.</p>
            </section>
            ...
            <section className="bg-gray-50 p-6 rounded-lg shadow-md space-y-4">
                ...
                <p>Die Anmeldung hat schriftlich zu erfolgen.Wird eine Förderung (z. B. nach dem SGB III) in Anspruch genommen, ist ein entsprechender schriftlicher Weiterbildungsvertrag abzuschließen.Mit Vertragsschluss erkennt der Teilnehmer die Teilnahmebedingungen und die Allgemeinen Geschäftsbedingungen des Bildungsträgers an</p>
            </section>
            ...
            <section className="bg-gray-50 p-6 rounded-lg shadow-md space-y-4">
                ...
                <p>Die Lehrgänge haben einen vertraglich festgelegten Leistungszeitraum. Sie werden in Vollzeit und Teilzeit sowie berufsbegleitend angeboten.</p>
                <p>
            ...
            <section className="bg-gray-50 p-6 rounded-lg shadow-md space-y-4">
                ...
                <p>
                    Für die Teilnahme an den Lehrgängen gelten folgende Kündigungsbedingungen: <br/>
                    Die Kündigung hat schriftlich zu erfolgen. Das Fernbleiben des Teilnehmers von einem gebuchten Lehrgang gilt in keinem Fall als Kündigung. Die Dozenten oder die Tutoren sind zur Entgegennahme von Kündigungen nicht befugt.Der Teilnehmer ist, solange keine schriftliche Kündigung erfolgt, in jedem Fall zur Zahlung der vollen Lehrgangsgebühren verpflichtet.Im Falle einer Kündigung werden die Gebühren bis zum Ende der Kündigungsfrist berechnet, sofern bereits Schulungsleistungen seitens des Bildungsträgers erbracht worden sind.Sind noch keine Schulungsleistungen seitens des Bildungsträgers erbracht, aber bereits ein Zugang zur Lernplattform für den Teilnehmer eingerichtet, ist der Teilnehmer verpflichtet, eine Grundgebühr in Höhe von 65,- € zu zahlen.
                </p>
            ...
            <section className="bg-gray-50 p-6 rounded-lg shadow-md space-y-4">
                ...
                <p>Der Teilnehmer bestätigt seine Kenntnis der technischen Voraussetzungen (sofern erforderlich) für die Lehrgangsteilnahme. Der Teilnehmer ist für die von ihm eingesetzte Hard- und Software sowie für die von ihm genutzten Kommunikationswege verantwortlich. Ein Ausfall der von ihm genutzten Hard- und Software entbindet nicht von der Verpflichtung zur Zahlung der Lehrgangsgebühr und stellt keinen Gegenstand einer Sonderkündigung dar.</p>
                <p>
            ...
            <section className="bg-gray-50 p-6 rounded-lg shadow-md space-y-4">
                <div className="flex items-center mb-2">
                    <div className="w-1 h-6 bg-orange-500 mr-3 rounded"></div>
                    <h2 className="text-2xl font-semibold">Fälligkeit der Lehrgangsgebühr</h2>
                </div>
                <p>Eine Zahlung der Lehrgangsgebühren erfolgt i. d. R. bis zum vereinbarten Lehrgangsstarttermin, spätestens jedoch vierzehn Tage nach dem Vertragsabschluss. Der Teilnehmer erhält bei Anmeldung eine entsprechende Rechnung.</p>
                <p>
...
Im Falle einer davon abweichenden Regelung befindet sich diese im Weiterbildungsvertrag dokumentiert. Ist der Kostenträger der Maßnahme nicht der Teilnehmer und wünscht der Kostenträger eine direkte Abrechnung mit dem Bildungsträger, so tritt der Bildungsträger bezüglich der Leistungsabrechnung an den Kostenträger heran. Dies gilt auch bei einer anteiligen Kostenabrechnung mit Dritten.
            ...
            <section className="bg-gray-50 p-6 rounded-lg shadow-md space-y-4">
                ...
                <p>
                    <b><u>Abschlussarbeit</u></b> <br/>
                    Der Abgabe einer Abschlussarbeit muss eine Zulassung des Themas durch den Tutor vorhergehen. Der Antrag auf Zulassung erfolgt in Form eines Briefings. Eine Nachricht über die Zulassung übermittelt der Tutor per E-Mail. Eine Einhaltung der sachlichen und formalen Vorgaben ist dabei erforderlich.
Sowohl das erfolgreiche Absolvieren der Prüfungen als auch die Abgabe der Abschlussarbeit müssen innerhalb des vereinbarten Leistungszeitraums erfolgen.
            ...
            <section className="bg-gray-50 p-6 rounded-lg shadow-md space-y-4">
                ...
                <p>Sollten die vom Bildungsträger bereitgestellten Informationen unzutreffend oder nicht mehr aktuell sein, wird der Anbieter dem Teilnehmer fehlerfreie und aktualisierte Informationen nachliefern. Soweit die Ersatzlieferung fehlschlägt, hat der Teilnehmer das Recht auf Rückgängigmachung oder Herabsetzung der gezahlten Vergütung.</p>
                <p>
                ...
                <p>
                    <b><u>Nebenabreden/Vertragliche Vereinbarung </u></b><br/>
