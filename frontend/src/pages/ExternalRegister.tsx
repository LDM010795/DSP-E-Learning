...
import {
    IoMailOutline,
    IoPersonOutline,
    IoLockClosedOutline, IoEyeOffOutline, IoEyeOutline} from "react-icons/io5"
            ...
            <div className="max-w-md w-full bg-white/95 shadow-xl rounded-2xl p-8 space-y-6 border border-white/20">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        {fieldErrors.password_confirm && <div className="text-sm text-red-500">{fieldErrors.password_confirm}</div>}
                    </div>
                    <div>
                        <ButtonPrimary
                            type="submit"
